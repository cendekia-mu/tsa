...
@view_config(route_name='view_page', renderer='wiki:templates/view.jinja2',
             permission='view')
...
@view_config(route_name='edit_page', renderer='wiki:templates/edit.jinja2',
             permission='edit')
...
@view_config(route_name='add_page', renderer='wiki:templates/edit.jinja2',
             permission='create')
