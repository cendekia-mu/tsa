...
@view_config(route_name='view_page', renderer='wiki2:templates/view.pt',
             permission='view')
...
@view_config(route_name='edit_page', renderer='wiki2:templates/edit.pt',
             permission='edit')
...
@view_config(route_name='add_page', renderer='wiki2:templates/edit.pt',
             permission='create')
